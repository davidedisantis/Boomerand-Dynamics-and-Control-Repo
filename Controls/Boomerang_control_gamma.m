...
max_dg = 110;              % Max delta of joint angle [deg]
max_dg = deg2rad(max_dg);  
min_dg = -100;              % Min delta of joint angle [deg]
min_dg = deg2rad(min_dg);
...
sim = sim("Boomerang_gamma_simulink");
