...
% Venus at 52 km, 0 deg longitude, 30 deg latitude. Source: http://www-venus.lmd.jussieu.fr/vcd_python/

g = 9.81;                     % Gravity acceleration on Venus [m/s^2]
rho = 1.3288004;              % Air density [kg/m^3]
% rho = 1.22;
...
PHI0 = 78;                                  % Initial roll angle (Between non-spinning frame and inertial) [deg]
PHI0 = deg2rad(PHI0);
